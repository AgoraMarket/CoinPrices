...
def get_prices_coins():
    ...
    # USD
    bch_data_usd = BchPrices.query.filter_by(id=1).first()
    ...
    # EUR
    bch_data_eur = BchPrices.query.filter_by(id=2).first()
    ...
    # JPY
    bch_data_jpy = BchPrices.query.filter_by(id=3).first()
    ...
    # CAD
    bch_data_cad = BchPrices.query.filter_by(id=4).first()
    ...
    # GBP
    bch_data_gbp = BchPrices.query.filter_by(id=5).first()
